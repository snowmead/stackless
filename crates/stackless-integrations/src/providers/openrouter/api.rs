...
pub const RESOURCE_KIND: &str = "integration-openrouter";

#[derive(Debug, Serialize)]
pub struct OpenRouterApiConfig {}

impl CatalogService for OpenRouterApiConfig {
    const REFERENCE: &'static str = "openrouter/api";
}
...
mod tests {
    ...
    fn config_matches_catalog() {
        ...
        let failures = stackless_stripe_projects::verify_service(&catalog, &OpenRouterApiConfig {});
        assert!(
            failures.is_empty(),
            "openrouter/api catalog gaps:\n{}",
            failures.join("\n")
        );
    }

    const CATALOG_ENVELOPE: &str = r##"{"ok":true,"command":"projects catalog","data":{"last_updated":"2026-07-11T00:00:00Z","services":[{"id":"prvsvc_api","object":"v2.provisioning.provider_service_detail","provider":"prvdr_openrouter","provider_name":"OpenRouter","service_id":"api","categories":["database"],"kind":"deployable","scope":"project","availability":"available","development":false,"livemode":true,"pricing":{"type":"component"},"configuration_schema":{"type":"object","required":[],"additionalProperties":false,"properties":{}}}]}}"##;
...
"#,
    ...
    async fn provision_records_outputs() {
        ...
        let resource = OpenRouterApi
            ...
            .await
            .unwrap();
        assert_eq!(resource.resource_kind, "integration-openrouter");
