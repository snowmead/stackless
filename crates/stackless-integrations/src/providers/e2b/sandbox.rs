...
pub const RESOURCE_KIND: &str = "integration-e2b";

#[derive(Debug, Serialize)]
pub struct E2BSandboxConfig {}

impl CatalogService for E2BSandboxConfig {
    const REFERENCE: &'static str = "e2b/sandbox";
}
...
mod tests {
    ...
    fn config_matches_catalog() {
        ...
        let failures = stackless_stripe_projects::verify_service(&catalog, &E2BSandboxConfig {});
        assert!(
            failures.is_empty(),
            "e2b/sandbox catalog gaps:\n{}",
            failures.join("\n")
        );
    }

    const CATALOG_ENVELOPE: &str = r##"{"ok":true,"command":"projects catalog","data":{"last_updated":"2026-07-11T00:00:00Z","services":[{"id":"prvsvc_sandbox","object":"v2.provisioning.provider_service_detail","provider":"prvdr_e2b","provider_name":"E2B","service_id":"sandbox","categories":["database"],"kind":"deployable","scope":"project","availability":"available","development":false,"livemode":true,"pricing":{"type":"component"},"configuration_schema":{"type":"object","required":[],"additionalProperties":false,"properties":{}}}]}}"##;
