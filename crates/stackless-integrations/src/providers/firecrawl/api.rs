...
pub const RESOURCE_KIND: &str = "integration-firecrawl";

#[derive(Debug, Serialize)]
pub struct FirecrawlApiConfig {}

impl CatalogService for FirecrawlApiConfig {
    const REFERENCE: &'static str = "firecrawl/api";
}

#[derive(Debug)]
pub struct FirecrawlApi;
...
mod tests {
    ...
    fn config_matches_catalog() {
        ...
        let failures = stackless_stripe_projects::verify_service(&catalog, &FirecrawlApiConfig {});
        assert!(
            failures.is_empty(),
            "firecrawl/api catalog gaps:\n{}",
            failures.join("\n")
        );
    }

    const CATALOG_ENVELOPE: &str = r##"{"ok":true,"command":"projects catalog","data":{"last_updated":"2026-07-11T00:00:00Z","services":[{"id":"prvsvc_api","object":"v2.provisioning.provider_service_detail","provider":"prvdr_firecrawl","provider_name":"Firecrawl","service_id":"api","categories":["database"],"kind":"deployable","scope":"project","availability":"available","development":false,"livemode":true,"pricing":{"type":"component"},"configuration_schema":{"additionalProperties":false,"properties":{},"type":"object"}}]}}"##;
