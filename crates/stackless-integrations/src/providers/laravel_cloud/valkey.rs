//! `laravel_cloud/valkey` integration.
...
pub const RESOURCE_KIND: &str = "integration-laravel-cloud-valkey";

#[derive(Debug, Serialize)]
pub struct LaravelCloudValkeyConfig {
    pub instance_size: String,
    pub region: String,
}

impl CatalogService for LaravelCloudValkeyConfig {
    const REFERENCE: &'static str = "laravel_cloud/valkey";
}

#[derive(Debug)]
pub struct LaravelCloudValkey;
...
impl FamilyResource for LaravelCloudValkey {
    ...
    ) -> Result<LaravelCloudValkeyConfig, IntegrationError> {
        let config = super::integration_config(ctx)?;
        Ok(LaravelCloudValkeyConfig {
...
project = "project_1"
[integrations.res]
provider = "laravel-cloud-valkey"
instance_size = "valkey-flex-250mb"
region = "us-east-1"
[services.api]
...
"#,
    ...
    async fn provision_records_outputs() {
        ...
        let resource = LaravelCloudValkey
            .provision(
                &stripe.as_dyn(),
                &test_def(),
                dir.path(),
