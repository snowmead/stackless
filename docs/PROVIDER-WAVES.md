...
| 7 | Chatbase, Composio, Customer.io, Depot, Pydantic Logfire, RevenueCat, Schematic, Steel, Tabstack, Datadog (`datadog/observability`), Twilio (`twilio/email`) (exclude Spaceship domain; NodeOps/Klaviyo absent; Datadog/Twilio plan tiers are not adapters) |
